...
public class BaldEagle
{
	...
	// main menu UI
	private static JLabel mainMenuHeader = new JLabel("Bald Eagle Solitaire");
	private static String[] gameList = {"Game 1","Game 2","Game 3"};
	private static JComboBox gameSelectDropDown = new JComboBox(gameList);
