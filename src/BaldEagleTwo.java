...
public class BaldEagleTwo
{
	...
	{
		BaldEagleTwo.score += deltaScore;
		String newScore = "Score: " + BaldEagleTwo.score;
	...
	private static class CardMovementManager extends MouseAdapter
	{
		...
		public void mousePressed(MouseEvent e)
		{
			...
			if (newCardButton.contains(start) && deck.showSize() > 0)
			{
				...
				table.add(BaldEagleTwo.moveCard(c, SHOW_POS.x, SHOW_POS.y));
				c.repaint();
				table.repaint();
				prevCard = c;
			}
	...
	private static void playNewGame()
	{
		...
		gameTitle.setText("<b>Bald Eagle Solitaire(Version 2)</b>");
